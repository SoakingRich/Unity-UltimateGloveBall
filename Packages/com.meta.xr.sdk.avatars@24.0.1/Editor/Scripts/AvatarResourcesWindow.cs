...
{
    /* This class creates a debug window AvatarSDK2 => Resource Window showing Resource Loaders and GPU Skinning info */
    public class AvatarResourcesWindow : EditorWindow
    {
        private enum ResourceTabId
        {
            Loaders = 0,
            GpuSkinning = 1,
        ...
        private static readonly string[] _inputPrefixes = { "neutral", "morphSrc", "morphCombined", "indirection", "joints" };
        private static readonly string[] _outputPrefixes = { "morphJointSkinnerOutput", "jointSkinnerOutput", "morphSkinnerOutput" };

        private long _totalTextureMemoryUsed = 0;
        private long _totalMeshMemoryUsed = 0;

        [MenuItem("MetaAvatarsSDK/Resources Window")]
        static void Init()
        {
