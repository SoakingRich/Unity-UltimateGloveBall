...
namespace Oculus.Avatar2
{
    public static partial class CAPI
    {
        ...
        internal static bool OvrAvatar2Asset_ReleaseResource(ovrAvatar2Id resourceId)
        {
            return ovrAvatar2Asset_ReleaseResource(resourceId)
                .EnsureSuccess("ovrAvatar2Asset_ReleaseResource");
        }

        internal static bool OvrAvatar2Asset_ResourceReadyToRender(ovrAvatar2Id resourceId)
        {
        ...
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern CAPI.ovrAvatar2Result ovrAvatar2Asset_GetQuality(
            ovrAvatar2Id primitiveId, out ovrAvatar2EntityQuality quality);
        ...
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern CAPI.ovrAvatar2Result ovrAvatar2VertexBuffer_GetSubMeshTypesLogFloat(
            ovrAvatar2Id primitiveId, ovrAvatar2VertexBufferId vertexBufferId, /*float[]*/ IntPtr buffer, UInt32 bytes,
            UInt32 stride);

        // Get vertex buffer submesh types
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern CAPI.ovrAvatar2Result ovrAvatar2VertexBuffer_GetMaterialTypes(
            ovrAvatar2Id primitiveId, ovrAvatar2VertexBufferId vertexBufferId, /*Uint32[]*/ IntPtr buffer, UInt32 bytes,
            UInt32 stride);

        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern CAPI.ovrAvatar2Result ovrAvatar2VertexBuffer_GetMaterialTypesFloat(
            ovrAvatar2Id primitiveId, ovrAvatar2VertexBufferId vertexBufferId, /*float[]*/ IntPtr buffer, UInt32 bytes,
            UInt32 stride);
