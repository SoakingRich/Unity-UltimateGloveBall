...
namespace Oculus.Avatar2
{
    ...
    public static partial class CAPI
    {
        ...
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        private static extern ovrAvatar2Result ovrAvatar2Entity_SetCreationContext(ovrAvatar2EntityId entityId, Experimental.CAPI.ovrAvatar2StringView creationContext);

        public static bool ovrAvatar2Entity_SetCreationContext(ovrAvatar2EntityId entityId, string creationContext)
        {
            return ovrAvatar2Entity_SetCreationContext(entityId, OvrAvatarUtility.stringToOvrAvatar2StringView(creationContext))
                .EnsureSuccess("ovrAvatar2Entity_SetCreationContext");
        }
