...
namespace Oculus.Skinning.GpuSkinning
{
    internal class OvrGpuCombinerDrawCall
    {
            ...
            bool useSNorm10)
        {
            ...
            _combineMaterial.SetBuffer(MORPH_TARGET_WEIGHTS_PROP, OvrAvatarManager.Instance.SkinningController.GetWeightsBuffer());
        ...
        internal IntPtr GetMorphWeightsBuffer(OvrSkinningTypes.Handle handle)
        {
            if (_handleToBlockData.TryGetValue(handle, out BlockData blockData))
            {
                ...
                var entry = OvrAvatarManager.Instance.SkinningController.GetNextEntryWeights(blockData.numMorphTargets);
