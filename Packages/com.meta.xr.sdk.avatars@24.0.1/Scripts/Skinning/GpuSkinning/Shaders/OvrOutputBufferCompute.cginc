...
void StoreVertexNormal(
  ...
  OvrStoreUint(
      output_buffer,
      address,
      OvrPackSnorm4x10_10_10_2(float4(normalize(normal.xyz), 0.0)));
}
...
void StoreVertexTangent(
  ...
  OvrStoreUint(
      output_buffer,
      address,
      OvrPackSnorm4x10_10_10_2(float4(normalize(tangent.xyz), tangent.w)));
}
...
void StoreVertexOutput(
    ...
    inout RWByteAddressBuffer frenet_output_buffer,
