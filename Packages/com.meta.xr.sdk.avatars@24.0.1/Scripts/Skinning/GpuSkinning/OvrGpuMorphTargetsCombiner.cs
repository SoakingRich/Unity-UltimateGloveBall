...
namespace Oculus.Skinning.GpuSkinning
{
    public class OvrGpuMorphTargetsCombiner
    {
            ...
            Shader combineMorphTargetsShader)
        {
            ...
            var description = GetRenderTexDescriptor(width, height, NUM_INITIAL_SLICES, texFormat);
        ...
        public OvrAvatarSkinningController parentController = null;
        ...
        private static RenderTextureDescriptor GetRenderTexDescriptor(int width, int height, int slices, GraphicsFormat format)
        {
            return new RenderTextureDescriptor(width, height, format, DEPTH_BITS, MIP_COUNT)
            {
