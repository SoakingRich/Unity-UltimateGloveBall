...
namespace Oculus.Avatar2
{
    ...
    public sealed class AvatarLOD : MonoBehaviour
    {
        ...
        private void Awake()
        {
#if UNITY_EDITOR || UNITY_DEVELOPMENT || UNITY_STANDALONE_WIN
            _avatarId = ++_avatarIdSource;
#endif // UNITY_EDITOR || UNITY_DEVELOPMENT || UNITY_STANDALONE_WIN
