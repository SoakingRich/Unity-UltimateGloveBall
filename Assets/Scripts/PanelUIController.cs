...
namespace NovaSamples.HandMenu
{
    ...
    public class PanelUIController : MonoBehaviour
    {
        ...
        // private XRHandTrackingEvents hand = null;                          // hand to attach menu to
        ...
        public InputManager handMenuInputManager;
        ...
        private void Update()
        {
            ...
            if (handMenuInputManager == null)
            {
                handMenuInputManager = FindObjectOfType<InputManager>();
                return;
            }
            ...
            if(handLauncherPivot == null)
            {
                handLauncherPivot = GameObject.FindGameObjectWithTag("HandLauncherPivot")?.transform;
                return;
            }
            
            if(panelPopupLocation == null)
            {
                panelPopupLocation = GameObject.FindGameObjectWithTag("PopUpMenuAnchor").transform;
                return;
            }
